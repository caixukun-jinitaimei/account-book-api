...
public class Helper extends SQLiteOpenHelper {
    ...
    public static final String Row_Shops = "Shops";
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "create table " + TableName + "( "+Row_ID+" INTEGER primary key AUTOINCREMENT, "+Row_Date+" varchar(20), "+Row_Time+" varchar(20), "+Row_Type+" INTEGER,"+Row_Label+" varchar(20),"+Row_Name+" varchar(20),"+Row_Price+" varchar(20),"+Row_Shops+" varchar(20));";
        db.execSQL( sql );
    }
