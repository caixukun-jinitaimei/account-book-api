...
public class Dao {
    ...
    public int Insert(Record record) {
        ...
        if (DB.isOpen()) {
            ...
            values.put(Helper.Row_Shops, record.getGoodsShops());
    ...
    public List<Record> QueryAll() {
        ...
        if (DB.isOpen()) {
            String[] columns = {Helper.Row_Date,Helper.Row_Time,Helper.Row_Type,Helper.Row_Label,Helper.Row_Name,Helper.Row_Price,Helper.Row_Shops};
